        ...
        foreach ( $team_posts as $post ):
            ...
            <article class="col-sm-6 profile">
                <div class="profile-header">
                    <?php if ( $thumb_src ): ?>
                        <img src="<?php echo $thumb_src; ?>" alt="<?php the_title(); ?>, <?php get_post_meta($post->ID, 'position')[0]; ?>" class="img-circle">
                    <?php endif; ?>
                </div>

                <div class="profile-content">
                    <h3><?php the_title(); ?></h3>
                    <p class="lead position"><?php get_post_meta($post->ID, 'position')[0] ?></p>
                    <?php the_content(); ?>
                </div>
